    ...
    if ((!BUILD.lazyLoad || !(flags & 8 /* isConstructingInstance */) || oldVal === undefined) && newVal !== oldVal) {
        ...
        if (!BUILD.lazyLoad || instance) {
            ...
            if (BUILD.watchCallback && cmpMeta.$watchers$) {
                if (!BUILD.lazyLoad || flags & 128 /* isWatchReady */) {
        ...
        if (BUILD.style && Cstr.style) {
            ...
            if (!styles.has(scopeId)) {
                ...
                if (!BUILD.hydrateServerSide && BUILD.shadowDom && BUILD.shadowDomShim && cmpMeta.$flags$ & 8 /* needsShadowDomShim */) {
                    style = await __sc_import_ionicons_site('./shadow-css-a27537cf.js').then(m => m.scopeCss(style, scopeId, false));
                }
...
export { BUILD as B, CSS as C, H, NAMESPACE as N, promiseResolve as a, bootstrapLazy as b, consoleDevInfo as c, doc as d, Build as e, forceUpdate as f, getRenderingRef as g, h, getElement as i, Host as j, createEvent as k, getContext as l, plt as p, registerInstance as r, win as w };
