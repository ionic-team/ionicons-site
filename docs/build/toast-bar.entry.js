    ...
    render() {
        ...
        if (this.selectedIcon) {
            ...
            activeDownloadLinks = this.selectedIcon.icons.map((name) => {
                ...
                return (h("div", { class: "toast-bar__section" }, h("div", { class: "toast-bar__section-header" }, h("h6", null, heading)), h("div", { class: "btn-group" }, h("div", { class: "btn btn--gray btn--small btn--icon" }, h("svg", null, h("use", { xlinkHref: `#${name}` }))), h("a", { class: "btn btn--gray btn--small", download: `/ionicons/svg/${name}.svg`, href: `/ionicons/svg/${name}.svg` }, h("svg", null, h("use", { xlinkHref: `#download` })), "SVG"))));
            });
        }
