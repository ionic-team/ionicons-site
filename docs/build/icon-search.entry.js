import { r as registerInstance, e as createEvent, h } from './core-2191ed9d.js';
...
const IconSearch = class {
    ...
    render() {
        return (h("div", { class: `search-input search-input--${this.size}` }, h("i", { class: "search-input__icon" }, h("svg", null, h("use", { xlinkHref: `#search-outline` }))), h("input", { type: "text", placeholder: "Search icons...", value: this.query, autofocus: this.autofocus === 'autofocus' ? 'autofocus' : '' }), h("i", { class: {
