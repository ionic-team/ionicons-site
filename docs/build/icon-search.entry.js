...
const IconSearch = class {
    ...
    render() {
        return (h("div", { class: `search-input search-input--${this.size}` }, h("input", { type: "text", placeholder: "Search icons...", value: this.query, autofocus: this.autofocus === 'autofocus' ? 'autofocus' : '' }), h("i", { class: {
