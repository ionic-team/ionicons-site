...
const LandingPage = class {
    ...
    render() {
        ...
        return (h("div", { class: "icon-list" }, h("div", { class: "icon-list__search container--small" }, h("icon-search", { query: this.query, size: "large", autofocus: "autofocus" })), results.icon.length ?
            h("div", { class: "icon-list__wrapper" }, h("div", { class: "icon-list__header-bar" }, h("div", { class: "container--small" }, h("h4", null, "App icons"), h("ul", { class: "toggle" }, h("li", { class: `toggle__item ${(this.selectedIconType === 'filled') ? 'active' : ''}`, onClick: ev => this.handleToggleClick(ev, 'filled') }, "Filled"), h("li", { class: `toggle__item ${(this.selectedIconType === 'outline') ? 'active' : ''}`, onClick: ev => this.handleToggleClick(ev, 'outline') }, "Outline"), h("li", { class: `toggle__item ${(this.selectedIconType === 'sharp') ? 'active' : ''}`, onClick: ev => this.handleToggleClick(ev, 'sharp') }, "Sharp")))), h("div", { class: "container--small" }, h("div", { class: "icon-results" }, results.icon.map(icon => (h("span", { class: `icon-results__cell ${(this.selectedIcon === icon.name) ? 'active' : ''}`, onClick: (ev) => this.handleIconClick(ev, icon.name), onMouseEnter: (ev) => this.handleIconMouseEnter(ev), onMouseLeave: (ev) => this.handleIconMouseLeave(ev) }, h("svg", null, h("use", { xlinkHref: `#${icon.name + typeSuffix}` }))))))))
            : '', results.logo.length ?
